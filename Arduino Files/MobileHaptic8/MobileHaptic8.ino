...
if(pos02 > 70 && detach04 == false)
{
  myservo04.detach();
}
else if(pos02 < 70 && detach04 == true)
{
  myservo04.attach(2);
  myservo04.write(180 - pos02);
}
else if(pos02 < 70 && detach04 == false)
{
  myservo04.write(180 - pos02);
}

    myservo05.write(180 - pos02 -25);
    
if(pos03 > 70 && detach06 == false)
{
  myservo06.detach();
}
else if(pos03 < 70 && detach06 == true)
{
  myservo06.attach(6);
  myservo06.write(pos03);
}
else if(pos03 < 70 && detach06 == false)
{
    myservo06.write(pos03);
}
    
    myservo07.write(pos03 +25);
